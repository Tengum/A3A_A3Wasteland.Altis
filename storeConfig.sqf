...
[
	...
	["Sting SMG", "SMG_02_F", 500],
	["Vermin SMG", "SMG_01_F", 600]
];
...
[
	...
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", ],
...
[
	...
	["Static Titan AT 4Rnd", "B_static_AT_F", 8000], // Static launchers have 4 ammo and are extremely effective against armor.
	...
	["Mk6 Mortar", "B_Mortar_01_F", 22000],
	["Mk6 Mortar", "O_Mortar_01_F", 22000],
	["Mk6 Mortar", "I_Mortar_01_F", 22000]
];

throwputArray = compileFinal str
[
	["RGN Mini Grenade", "MiniGrenade", 40],
	["RGO Frag Grenade", "HandGrenade", 65],
...
[
	...
	[".338 NM 130Rnd Belt", "130Rnd_338_Mag", 1200],
	...
	["40mm 3Rnd HE Grenades", "3Rnd_HE_Grenade_shell", 350],
...
[
	...
	["Suppressor .338", "muzzle_snds_338_black", 1100, "item"],
	["Suppressor .338 (Green)", "muzzle_snds_338_green", 1100, "item"],
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 1100, "item"],
	...
	["AMS", "optic_AMS", 1150, "item"],
	["AMS (Khaki)", "optic_AMS_khk", 1150, "item"],
	["AMS (Sand)", "optic_AMS_snd", 1150, "item"],
	["LRPS", "optic_LRPS", 1150, "item"],
	["LRPS (G Hex)", "optic_LRPS_ghex_F", 1150, "item"],
	["LRPS (Tropic)", "optic_LRPS_tna_F", 1150, "item"],
...
[
	...
	["Stealth Combat Helmet", "H_HelmetB_TI_tna_F", 900, "hat"],
...
[
	...
	["Full Ghillie (Arid)", "U_B_FullGhillie_ard", 3200, "uni"],
	["Full Ghillie (Arid)", "U_O_FullGhillie_ard", 3200, "uni"],
	["Full Ghillie (Arid)", "U_I_FullGhillie_ard", 3200, "uni"],
	["Full Ghillie (Lush)", "U_B_FullGhillie_lsh", 3200, "uni"],
	["Full Ghillie (Lush)", "U_O_FullGhillie_lsh", 3200, "uni"],
	["Full Ghillie (Lush)", "U_I_FullGhillie_lsh", 3200, "uni"],
	["Full Ghillie (Semi-Arid)", "U_B_FullGhillie_sard", 3200, "uni"],
	["Full Ghillie (Semi-Arid)", "U_O_FullGhillie_sard", 3200, "uni"],
	["Full Ghillie (Semi-Arid)", "U_I_FullGhillie_sard", 3200, "uni"],
	["Full Ghillie (Jungle)", "U_B_T_FullGhillie_tna_F", 3000, "uni"],
	["Full Ghillie (Jungle)", "U_O_T_FullGhillie_tna_F", 3000, "uni"],
	["CTRG Stealth Uniform", "U_B_CTRG_Soldier_F", 2800, "uni"],
...
[
	...
	["Carrier Special Rig (Green)", "V_PlateCarrierSpec_rgr", 1700, "vest"],
	["Carrier Special Rig (Black)", "V_PlateCarrierSpec_blk", 1700, "vest"],
	["Carrier Special Rig (MTP)", "V_PlateCarrierSpec_mtp", 1700, "vest"],
	["Carrier Special Rig (Tropic)", "V_PlateCarrierSpec_tna_F", 1700, "vest", "noDLC"],
...
[
	...
	["Bergen (Digital)", "B_Bergen_dgtl_F", 2550, "backpack", "noDLC"],
	["Bergen (Hex)", "B_Bergen_hex_F", 2550, "backpack", "noDLC"],
	["Bergen (MTP)", "B_Bergen_mcamo_F", 2550, "backpack", "noDLC"],
	["Bergen (Tropic)", "B_Bergen_tna_F", 2550, "backpack", "noDLC"]
];
...
[
	...
	["Mine Detector", "MineDetector", 700, "item"],
	...
	["Laser Designator (Sand)", "Laserdesignator", 20000, "binoc", "noDLC"], // Increase price to 2500 if A3W_disableBuiltInThermal = 0
	["Laser Designator (Hex)", "Laserdesignator_02", 20000, "binoc", "noDLC"],
	["Laser Designator (Olive)", "Laserdesignator_03", 20000, "binoc", "noDLC"],
...
[
	...
	["Ifrit HMG", "O_MRAP_02_hmg_F", 17000hicle"],
	["Ifrit GMG", "O_MRAP_02_gmg_F", 19000ehicle"],
	["Strider", "I_MRAP_03_F", 9000, "vehicle"],
	["Strider HMG", "I_MRAP_03_hmg_F", 17000ehicle"],
	["Strider GMG", "I_MRAP_03_gmg_F", 19000ehicle"],
...
[
	["CRV-6e Bobcat (Resupply)", "B_APC_Tracked_01_CRV_F", 35000ehicle"],
	["IFV-6c Panther", "B_APC_Tracked_01_rcws_F", 37000ehicle"],
	["FV-720 Mora", "I_APC_tracked_03_cannon_F", 46000icle"],
	["BTR-K Kamysh", "O_APC_Tracked_02_cannon_F", 45000ehicle"],
...
[
	...
	["A-143 Buzzard AA", "I_Plane_Fighter_03_dynamicLoadout_F", 45000, "vehicle", "variant_buzzardAA"],
	...
	["V-44 X Blackfish (Infantry)", "B_T_VTOL_01_infantry_F", 30000, "vehicle"],
...
[
	...
	["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 6500, 4900],
	["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 6500, 4800],
	["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 6500, 4700]
];
